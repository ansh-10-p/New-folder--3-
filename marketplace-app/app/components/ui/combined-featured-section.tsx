...
import { Activity, ArrowRight, Files, Flower, GalleryVerticalEnd, MapPin, Globe } from 'lucide-react'
...
export default function CombinedFeaturedSection() {
  ...
  return (
    <section className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-4">
