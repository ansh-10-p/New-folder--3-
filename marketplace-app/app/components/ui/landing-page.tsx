      ...
      >
        <div className="container flex h-16 items-center justify-between border-x border-muted">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button_v4 variant="outline" size="sm" className="rounded-3xl">
              Log In
            </Button_v4>
            <Button_v4 size="sm" className="rounded-3xl">
              Get Started
            </Button_v4>
          </div>
        ...
        >
          ...
          >
            ...
            <motion.div variants={itemFadeIn} className="flex flex-col gap-3 pt-4">
              <Button_v4 variant="outline" className="w-full rounded-3xl">
                Log In
              </Button_v4>
              <Button_v4 className="w-full rounded-3xl">Get Started</Button_v4>
            </motion.div>
          </motion.nav>
        </motion.div>
      )}
          ...
          >
            ...
            >
              ...
              >
                ...
                <Image
                  src="https://images.unsplash.com/photo-1460925895917-adf4e565db57?w=1200&h=800&fit=crop"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://images.unsplash.com/photo-1516321318423-f06f70504504?w=600&h=600&fit=crop"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://images.unsplash.com/photo-1533346264976-c2ce4eda615d?w=600&h=600&fit=crop"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://images.unsplash.com/photo-1611162617305-c69b3fa7fbe0?w=1200&h=600&fit=crop"
            ...
            <div className="mt-16 px-6 pb-10">
              ...
              >
                {[
                  ...
                  >
                    <Image
                      src={`https://images.unsplash.com/photo-${1507003957449 + index}-?w=300&h=400&fit=crop`}
                      alt={member.name}
                      width={300}
                      height={400}
            ...
            >
              ...
              <form className="mt-6 space-y-3">
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button_v4 type="submit" className="w-full rounded-3xl">
                    Send Message
                  </Button_v4>
                </motion.div>
              </form>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <form className="flex space-x-3">
              ...
              <Button_v4 type="submit" className="rounded-3xl">
                Subscribe
              </Button_v4>
            </form>
          </div>
